  ...
  return (
    <>
      {tracks.map((track) => {
        ...
        return (
          <div
            className="w-full max-w-screen sm:w-[85vw] cursor-pointer"
            key={track.id}
          >
            <div
              className="flex text-gray-300 bg-[#33373e42] px-0 py-0 items-center rounded-xl mb-3 sm:grid sm:grid-flow-col grid-cols-6 max-w-sm sm:max-w-none"
