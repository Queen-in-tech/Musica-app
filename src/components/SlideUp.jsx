  ...
  return (
    ...
    vh] items-center mx-auto pb-6'>
          ...
          <div className="flex flex-col mt-6 items-center">
            <h3 className="text-white font-bold text-md text-center">{currentTracks.name}</h3>
            <h3 className="text-gray-400 font-light text-sm">{currentTracks.artists[0].name}</h3>
          </div>
